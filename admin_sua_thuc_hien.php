    ...
    <?php 
            ...
            //Ghi nhan buc anh UP tren he thong hay chua
                ...
                if ($anh_minh_hoa==NULL) {
                    $sql = "
                        UPDATE `tbl_admin` 
                        SET `ten` = '".$ten_ad."', `email` = '".$email."', `sdt` = '".$sdt."', `mat_khau` = '".$mat_khau."', `ghi_chu` = '".$ghi_chu."' 
                        WHERE `tbl_admin`.`id_admin` = '".$id_admin."'
                    ";
                } else {
                    $sql = "
                        UPDATE `tbl_admin` 
                        SET `ten` = '".$ten_ad."', `email` = '".$email."', `sdt` = '".$sdt."', `mat_khau` = '".$mat_khau."', `ghi_chu` = '".$ghi_chu."', `anh_minh_hoa` = '".$anh_minh_hoa."' 
                        WHERE `tbl_admin`.`id_admin` = '".$id_admin."'
                    ";
                }
