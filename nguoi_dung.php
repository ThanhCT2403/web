  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i><strong>Người dùng</strong></h3>
        <div class="row mb">
          <!-- page start-->
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  <?php
                                        ...
                                        <tr>
                                            <td><?php echo $i;?></td>
                                            <td><strong><?php echo $row["ten_nguoi_dung"];?></strong></td>
                                            <td><strong><?php echo $row["email"];?></strong></td>
                                            <td><strong><?php echo $row["sdt"];?></strong></td>
                                            <td><strong><?php echo $row["mat_khau"];?></strong></td>    
                                            <td><a style="color: green" href= "nguoi_dung_sua.php?id=<?php echo $row["id_nguoi_dung"];?>">Sửa</a></td>
                                            <td><a style="color: green" href= "nguoi_dung_xoa.php?id=<?php echo $row["id_nguoi_dung"];?>">Xóa</a></td>
                                        </tr>
                                        <?php
                                            }
                                        ;?>
