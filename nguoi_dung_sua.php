  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Cập nhật NGƯỜI DÙNG</h3>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            ;?>
                <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="nguoi_dung_sua_thuc_hien.php" enctype="multipart/form-data">
                  <div class="form-floating mb-3">
                                                <label for="inputEmail"><h4><strong>Tên người dùng</strong></h4></label>
                                                <input class="form-control" id="inputEmail" type="text"  name="txtTenND" value="<?php echo $row["ten_nguoi_dung"];?>"/>
                                            ...
                                            <div class="form-floating mb-3">
                                                <label for="inputEmail"><h4><strong>Mật khẩu</strong></h4></label>
                  ...
                  <br>
                    <div class="col-lg-offset-2 col-lg-10">
                      ...
                      <a class="btn btn-theme04" type="button" href="nguoi_dung.php">Thoát</a>
                    </div>
                  </div>
                </form>
              </div>
