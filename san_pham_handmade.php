  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i><strong>Quản lý SẢN PHẨM HANDMADE</strong></h3>
        <div class="row mb">
          <!-- page start-->
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  <?php
                                            ...
                                            $sql = "SELECT * FROM tbl_handmade ORDER BY id_san_pham DESC";
                                        ...
                                        <tr>
                                            ...
                                            <td><a style="color: green" href= "san_pham_handmade_sua.php?id=<?php echo $row["id_san_pham"];?>">Sửa</a></td>
                                            <td><a style="color: green" href= "san_pham_handmade_xoa.php?id=<?php echo $row["id_san_pham"];?>">Xóa</a></td>
                                        </tr>
                                        <?php
                                            }
                                        ;?>
        ...
        <a class="btn btn-primary btn-lg  btn-block btn-theme active" href = "san_pham_handmade_them_moi.php">Thêm mới sản phẩm</a>
        <!-- /row -->
      </section>
      <!-- /wrapper -->
    </section>
