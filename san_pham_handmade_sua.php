  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Cập nhật SẢN PHẨM HANDMADE</h3>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            ;?>
                <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="san_pham_handmade_sua_thuc_hien.php" enctype="multipart/form-data">
                  <div class="form-floating mb-3">
                                                <label for="inputEmail"><h4><strong>Tên sản phẩm</strong></h4></label>
                                                <input class="form-control" id="inputEmail" type="text"  name="txtTenSP" value="<?php echo $row["ten_san_pham"];?>"/>
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                <input class="form-control" id="inputEmail" type="text"  name="txtGiaTien" value="<?php echo $row["gia_tien"];?>"/>
                                                
                                            </div>
                                            <div class="form-floating mb-3">
                                                <label for="inputEmail"><h4><strong>Số lượng</strong></h4></label>
                                                <input class="form-control" id="inputEmail" type="text"  name="txtSoLuong" value="<?php echo $row["so_luong"];?>"/>
                  ...
                  <br>
                    <div class="col-lg-offset-2 col-lg-10">
                      ...
                      <a class="btn btn-theme04" type="button" href="san_pham_handmade.php">thoát</a>
                    </div>
                  </div>
                </form>
              </div>
