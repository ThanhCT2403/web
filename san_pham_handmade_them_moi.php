  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Thêm mới SẢN PHẨM HANDMADE</h3>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="san_pham_handmade_them_moi_thuc_hien.php" enctype="multipart/form-data">
                  <div class="form-floating mb-3">
                                                <label for="inputEmail"><h4><strong>Tên sản phẩm</strong></h4></label>
                                                <input class="form-control" id="inputEmail" type="text"  name="txtTenSP" />
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                <input class="form-control" id="inputEmail" type="text"  name="txtGiaTien" />
                                                
                                            </div>
                                            <div class="form-floating mb-3">
                                                <label for="inputEmail"><h4><strong>Số lượng</strong></h4></label>
                                                <input class="form-control" id="inputEmail" type="text"  name="txtSoLuong" />
