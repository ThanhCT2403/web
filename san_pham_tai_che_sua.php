  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Cập nhật SẢN PHẨM TÁI CHẾ</h3>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            ;?>
                <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="san_pham_tai_che_sua_thuc_hien.php" enctype="multipart/form-data">
                  ...
                  <br>
                    <div class="col-lg-offset-2 col-lg-10">
                      ...
                      <a class="btn btn-theme04" type="button" href="san_pham_tai_che.php">Thoát</a>
                    </div>
                  </div>
                </form>
              </div>
