  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Thêm mới SẢN PHẨM TÁI CHẾ</h3>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="san_pham_tai_che_them_moi_thuc_hien.php" enctype="multipart/form-data">
