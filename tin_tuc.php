  ...
  <section id="container">
        ...
        <!--<ul class="nav top-menu">
          ...
          <!--<li class="dropdown">
            ...
            <ul class="dropdown-menu extended tasks-bar">
              ...
              <li>
                <li><a class="dropdown-item" href="404.html">Cài đặt</a></li>        
    ...
    <section id="main-content">
      <section class="wrapper">
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  <?php
                                        ...
                                        <tr>
                                            <td><?php echo $i;?></td>
                                            <td><strong><?php echo $row["tieu_de"];?></strong></td> 
                                            <td><?php echo $row["ngay_dang"];?></td>
                                            <td><a style="color: green" href= "tin_tuc_sua.php?id=<?php echo $row["id_tin_tuc"];?>">Sửa</a></td>
                                            <td><a style="color: green" href= "tin_tuc_xoa.php?id=<?php echo $row["id_tin_tuc"];?>">Xóa</a></td>
                                        </tr>
                                        <?php
                                            }
                                        ;?>
        ...
        <a class="btn btn-primary btn-lg  btn-block btn-theme active" href = "tin_tuc_them_moi.php">Thêm mới tin tức</a>
        <!-- /row -->
      </section>
      <!-- /wrapper -->
    </section>
